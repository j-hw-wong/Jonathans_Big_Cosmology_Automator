...
def plot_multiple_contours(contour_params, title, labels, plot_save_path):
    ...
    lines.append(Line2D([0], [0], color='0', marker='^', linewidth=3, linestyle='None'))
    labels.append('Fiducial Cosmology')
    labels.append('Best Fit Cosmology')
