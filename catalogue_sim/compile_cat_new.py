...
def execute_cat_compilation():
    ...
    weightings = np.array(dat.get('Galaxy_Weighting'))
    ...
    weightings = np.float32(weightings)
    ...
    master_cat.create_dataset("Galaxy_Weighting", data=weightings, compression="gzip")
    master_cat.close()
